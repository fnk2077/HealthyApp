...
import 'shopping_basket_model.dart';
export 'shopping_basket_model.dart';

class ShoppingBasketWidget extends StatefulWidget {
  const ShoppingBasketWidget({Key? key}) : super(key: key);

  @override
  _ShoppingBasketWidgetState createState() => _ShoppingBasketWidgetState();
}

class _ShoppingBasketWidgetState extends State<ShoppingBasketWidget> {
  late ShoppingBasketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShoppingBasketModel());
  }
